...
{
    public class Tenant1UserService: DefaultUserService
    {
        public Tenant1UserService(ITenantIdentificationStrategy tenantIdentificationStrategy) : base(tenantIdentificationStrategy)
        {
        }
